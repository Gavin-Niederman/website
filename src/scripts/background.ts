...
class Renderer {
    ...
    constructor() {
        ...
        this.circles = [
            ...
            new Circle(67, 45, 80, 0.0),
            new Circle(78, 80, 75, 0.0),
        ]
    }
    ...
    render() {
        ...
        this.bgCircles.forEach((circle: Circle) => {
            this.context.drawImage(
                ...
                (circle.y - ((this.mouseY / 250) * (1 - circle.depth))) * (this.canvas.height / 100),
                circle.size * (this.canvas.height / 100), circle.size * (this.canvas.height / 100)
            );
        })
        this.context.fillStyle = "#0000006C"
        this.context.fillRect(0, 0, this.canvas.width, this.canvas.height);
